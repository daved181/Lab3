...
int main(int argc, char const *argv[])
{
  ...
  for (int crosses = 0; crosses < 60; crosses += 3) {
      ...
      //printf("%f %f %f %f \n %f %f %f %f \n ---------\n", points[faces[crosses] * 4], points[faces[crosses] * 4 + 1], points[faces[crosses] * 4 + 2], 0,
          //points[faces[crosses + 1] * 4], points[faces[crosses + 1] * 4 + 1], points[faces[crosses + 1] * 4 + 2], 0);
  }
  for (int c = 0; c < 60; c++) {
  ...
  glUniform1i(glGetUniformLocation(shader_program, "env_sampler"), 0);
  glBindTexture(GL_TEXTURE_CUBE_MAP, texture_handle);

  char* image_list[] = { "../../common/data/cube_back.png", "../../common/data/cube_down.png", "../../common/data/cube_front.png",
  "../../common/data/cube_left.png", "../../common/data/cube_right.png", "../../common/data/cube_up.png" };
